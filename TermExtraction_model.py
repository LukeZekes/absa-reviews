...
def create_model():
  ...
  train_data = prep_data(loaded_train_data, max_num_invalid=1500)
  ...
  model.fit(x=vectorized_train_input, y=train_output, validation_data=(vectorized_test_input, test_output), epochs=20)
